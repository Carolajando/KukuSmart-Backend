# KukuSmart â€” AI-Based Advisory System for Smallholder Poultry Farmers
...
1. Data Preprocessing â€” Images are cleaned, resized, normalized, and split into training, validation, and test sets. Augmentation is applied to improve model performance.

2. Model Training â€” A CNN model is trained to classify poultry diseases from images.

3. Chatbot Integration  â€” An AI chatbot handles farmer questions about symptoms, treatment, and vaccination.

4. User Flow  â€” Farmer uploads image ? receives disease prediction ? gets treatment guidance in English or Swahili.
